...
export type QuerySearchedQuizzesArgs = {
	cursor?: Maybe<Scalars['String']>;
...
> & {
		likes?: Maybe<
			Array<{ __typename?: 'Like' } & Pick<Like, 'quiz_id' | 'author_id'>>
		>;
		author: { __typename?: 'User' } & Pick<
			User,
			'id' | 'username' | 'email' | 'avatar'
...
export type MeQuizzesQuery = { __typename?: 'Query' } & {
	me_quizzes: { __typename?: 'PaginatedMeQuizzes' } & Pick<
		PaginatedMeQuizzes,
		'meHasMore'
	> & { me_quizzes: Array<{ __typename?: 'Quiz' } & QuizzesResponseFragment> };
};
...
export type QuizToUpdateQuery = { __typename?: 'Query' } & {
	quiz_to_update: { __typename?: 'Quiz' } & Pick<
		Quiz,
		'title' | 'description' | 'quiz_photo' | 'results'
	> & {
			questions: Array<
...
export type SearchedQuizzesQueryVariables = Exact<{
	limit: Scalars['Int'];
	query: Scalars['String'];
	cursor?: Maybe<Scalars['String']>;
}>;

export type SearchedQuizzesQuery = { __typename?: 'Query' } & {
	searched_quizzes: { __typename?: 'PaginatedQuizzes' } & Pick<
		PaginatedQuizzes,
		'has_more'
	> & { quizzes: Array<{ __typename?: 'Quiz' } & QuizzesResponseFragment> };
};
...
/**
 * __useSearchedQuizzesQuery__
 *
 * To run a query within a React component, call `useSearchedQuizzesQuery` and pass it any options that fit your needs.
 * When your component renders, `useSearchedQuizzesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useSearchedQuizzesQuery({
 *   variables: {
 *      limit: // value for 'limit'
 ...
 * });
 */
export function useSearchedQuizzesQuery(
	baseOptions: Apollo.QueryHookOptions<
		SearchedQuizzesQuery,
		SearchedQuizzesQueryVariables
	>
) {
	return Apollo.useQuery<SearchedQuizzesQuery, SearchedQuizzesQueryVariables>(
		SearchedQuizzesDocument,
		baseOptions
	);
}
export function useSearchedQuizzesLazyQuery(
	baseOptions?: Apollo.LazyQueryHookOptions<
		SearchedQuizzesQuery,
		SearchedQuizzesQueryVariables
	>
	...
	return Apollo.useLazyQuery<
		SearchedQuizzesQuery,
		SearchedQuizzesQueryVariables
	>(SearchedQuizzesDocument, baseOptions);
}
export type SearchedQuizzesQueryHookResult = ReturnType<
	typeof useSearchedQuizzesQuery
>;
export type SearchedQuizzesLazyQueryHookResult = ReturnType<
	typeof useSearchedQuizzesLazyQuery
>;
export type SearchedQuizzesQueryResult = Apollo.QueryResult<
	SearchedQuizzesQuery,
	SearchedQuizzesQueryVariables
>;
