...
export type SearchedQuizzesQuery = (
  { __typename?: 'Query' }
  & { searched_quizzes: (
    { __typename?: 'PaginatedQuizzes' }
    & Pick<PaginatedQuizzes, 'has_more'>
 ...
 * });
 */
export function useSearchedQuizzesQuery(baseOptions: Apollo.QueryHookOptions<SearchedQuizzesQuery, SearchedQuizzesQueryVariables>) {
        return Apollo.useQuery<SearchedQuizzesQuery, SearchedQuizzesQueryVariables>(SearchedQuizzesDocument, baseOptions);
      }
export function useSearchedQuizzesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SearchedQuizzesQuery, SearchedQuizzesQueryVariables>) {
          return Apollo.useLazyQuery<SearchedQuizzesQuery, SearchedQuizzesQueryVariables>(SearchedQuizzesDocument, baseOptions);
        }
export type SearchedQuizzesQueryHookResult = ReturnType<typeof useSearchedQuizzesQuery>;
export type SearchedQuizzesLazyQueryHookResult = ReturnType<typeof useSearchedQuizzesLazyQuery>;
export type SearchedQuizzesQueryResult = Apollo.QueryResult<SearchedQuizzesQuery, SearchedQuizzesQueryVariables>;
