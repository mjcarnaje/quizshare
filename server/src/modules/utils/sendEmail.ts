	...
	let template = {
		...
		html: `<!DOCTYPE html>
							...
							* {
							...
							<body>
								<div class="flex flex-col justify-center min-h-screen py-6 bg-gray-100 sm:py-12 bg-purple-50">
										...
										<div class="relative px-4 py-10 bg-white shadow-xl sm:rounded-3xl sm:p-20">
											<div class="max-w-md mx-auto">
												<div class="w-full py-2">
													<h1 class="text-4xl font-semibold text-center text-purple-600 font-berkshire">
														Qs
													</h1>
												</div>
												...
												<div class="divide-y divide-gray-200">
													<div class="py-6 space-y-3 text-base leading-6 text-gray-700 sm:text-lg sm:leading-7">
														...
														<p>Please confirm that <span class="font-bold break-all">${email}</span> is your e-mail address by clicking on the button or click this ${url} below within 24 hours</p>
													</div>
													<div class="pt-6 w-full">
														<form class='w-full h-full' action="${url}" target='_blank'>
															<button type='submit' class="w-full p-3 text-lg font-medium leading-6 text-purple-800 bg-purple-100 rounded-lg font-poppins sm:text-lg sm:leading-7 focus:outline-none hover:bg-purple-200 hover:shadow-md">Verify</button>
														</form>
													</div>
												</div>
											</div>
